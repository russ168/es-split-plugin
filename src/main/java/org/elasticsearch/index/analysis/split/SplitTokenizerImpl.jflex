...
/**
 * Modifier: dong ai hua <dongaihua1201@nhn.com>
 */

import org.apache.lucene.analysis.standard.StandardTokenizerInterface;
import org.apache.lucene.analysis.tokenattributes.CharTermAttribute;
import org.elasticsearch.index.analysis.split.SplitTokenizer;
...
%{
  ...
  public static final int WORD_TYPE = SplitTokenizer.ALPHANUM;

  /** Numbers */
  public static final int NUMERIC_TYPE = SplitTokenizer.NUM;
   ...
   */
  public static final int SOUTH_EAST_ASIAN_TYPE = SplitTokenizer.SOUTHEAST_ASIAN;

  public static final int IDEOGRAPHIC_TYPE = SplitTokenizer.IDEOGRAPHIC;

  public static final int HIRAGANA_TYPE = SplitTokenizer.HIRAGANA;

  public static final int KATAKANA_TYPE = SplitTokenizer.KATAKANA;

  public static final int HANGUL_TYPE = SplitTokenizer.HANGUL;

  public static final int SPLIT_TYPE = SplitTokenizer.SPLIT;

  public static final int HIGHLIGHT_TYPE = SplitTokenizer.HIGHLIGHT;
